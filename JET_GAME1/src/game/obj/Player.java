...
public class Player extends HpRender{
    ...
    public Player () {
         super(new HP(50, 50));
         this.image= new ImageIcon(getClass().getResource("/game/image/jet1.png")).getImage();
         this.image_speed=new ImageIcon(getClass().getResource("/game/image/jetboost.png")).getImage();
